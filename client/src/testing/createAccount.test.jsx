...
describe('CreateAccount', () => {
    ...
    describe('password validation', () => {
        ...
        it('should show an error when passwords do not match', async () => {
            ...
            fireEvent.change(screen.getByLabelText(/verify password/i), { target: { value: 'different' } });
            fireEvent.click(screen.getByRole('button', { name: /create account/i }));

            await waitFor(() => {
                expect(screen.getByText(/invalid password/i, { selector: 'div' })).toBeInTheDocument();
            });
        });
